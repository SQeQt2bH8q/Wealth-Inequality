...
<<bar2, echo=FALSE, fig.width = 5, fig.height = 2.7, crop = TRUE, include = FALSE>>=
knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)
set.seed(2)
x <- sort(rnorm(20, 10, 3))
data <- data.frame(value = x, group = seq(1:20))
barplot(data$value ~ data$group, xlab = "", ylab = "Wealth")
abline(mean(x), 0, col = "blue")
@
\begin{center}
\includegraphics{figure/bar2-1.pdf}
\end{center}
You can imagine slicing the bars that extend above the blue line:
<<bar3, echo=FALSE, fig.width = 5, fig.height = 2.7, crop = TRUE, include = FALSE>>=
set.seed(2)
x <- sort(rnorm(20, 10, 3))
mx <- mean(x)
f <- function(x) {
...
top <- x - base
x1 <- c(base, top)
m <- matrix(x1, nrow = 2, byrow = TRUE)
barplot(m, ylab = "Wealth")
abline(mx, 0, col = "blue")
@
\begin{center}
...
the blue line:
<<bar4, echo=FALSE, fig.width = 5, fig.height = 2.7, crop = TRUE, include = FALSE>>=
set.seed(2)
x <- sort(rnorm(20, 10, 3))
mx <- mean(x)
f <- function(x) {
...
x1 <- c(base, top)
m <- matrix(x1, nrow = 2, byrow = TRUE)
barplot(m, ylim = c(0, 16), ylab = "Wealth")
abline(mx, 0, col = "blue")
@
\begin{center}
...
<<bar1, echo=FALSE, fig.height = 3, fig.width = 4, crop = TRUE, include = FALSE>>=
knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)
data <- data.frame(value = c(5, 6, 13), group = c("1", "2", "3"))
barplot(data$value ~ data$group, xlab = "Person", ylab = "Wealth")
abline(8, 0, col = "blue")
@
\begin{center}
...
<<echo = FALSE, fig.width = 5, fig.height = 5, crop = TRUE>>=
H <- function(G) {
  if (G < 0.5) {
    0.74*G
  }
...
H <- Vectorize(H)
x <- seq(0.0, 0.94, by = 0.01)
y <- H(x)
plot(x, y, type = 'l', ylim = c(0, 1), col = 'blue', xlab = 'Gini Index', ylab = 'Hoover Index')
abline(0, 1, col = 'gray')
@
...
<<plota, echo=FALSE, fig.height = 4, fig.width = 4, include = FALSE, crop = TRUE>>=
x <- c(0, 73.2, 91.7, 99.2, 100)
y <- c(0, 2.4, 13.8, 54.4, 100)
plot(x, y, pch = 20, xlab = "Percentage of Population", ylab = "Percentage of Wealth")
#smoothingSpline = smooth.spline(x, y, all.knots = TRUE, spar = 0.5)
...
<<Lorenz1, echo = FALSE, fig.height = 4, fig.width = 4, crop = TRUE, include = FALSE>>=
x <- c(0.0, 20, 40, 60, 80, 100)
y <- c(0.000, 7.1, 19.5, 37.0, 59.9, 100)
plot(x, y, pch = 20, xlab = "Percentile Rank in Wealth", ylab = "Cumulative Percentage of Wealth")
@
\begin{center}
...
<<Lorenz2, echo=FALSE, fig.height = 4, fig.width = 4, include = FALSE, crop = TRUE>>=
x <- c(0.0, 0.20, 0.40, 0.60, 0.80, 1.00)
y <- c(0.000, 0.071, 0.195, 0.370, 0.599, 1.00)
plot(x, y, pch = 20, xlab = "Percentile in Wealth", ylab = "Cumulative Proportion of Wealth")
#lo <- loess(y ~ x)
smoothingSpline <- smooth.spline(x, y, spar = 0.0)
lines(smoothingSpline, col = "blue")
...
\begin{center}
<<Lorenz0, echo=FALSE, fig.height = 4, fig.width = 4, crop = TRUE>>=
x <- c(0.0, 0.25, 0.50, 0.75, 1.00)
y <- c(0.000, 0.10, 0.3125, 0.5875, 1.00)
plot(x, y, pch = 20, xlab = "Rank in Wealth", ylab = "Cumulative Proportion of Wealth")
smoothingSpline <- smooth.spline(x, y, spar = 0.0)
lines(smoothingSpline, col = "blue")
@
\end{center}
